...
class SimpleRevenue(BaseComponent):
    ...
    Args:
        ...
        period (int): Length of a tax period in environment timesteps. Taxes are
            updated at the start of each period and collected at the
    ...
    def get_dense_log(self):
        ...
        Returns:
            taxes (list): A list of tax collections. Each entry corresponds to a single
                ...
                contains the tax schedule, each agent's reported income, and tax paid.
